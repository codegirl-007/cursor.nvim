...
- **Pending Review Queue**: The list only shows files still pending. Accept or reject drops that file; an empty list closes. Review status is not restored after restart.
